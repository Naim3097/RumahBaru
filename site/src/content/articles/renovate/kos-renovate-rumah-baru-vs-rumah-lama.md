...
tags: ["kos", "renovasi", "rumah-baru", "rumah-lama", "budget"]
includeFitoutNote: true
faqs:
  - q: "Adakah renovate rumah baru selalu lebih murah daripada rumah lama?"
    a: "Tidak semestinya. Rumah baru biasanya tidak memerlukan kerja struktural atau plumbing tetapi sering memerlukan upgrade kabinet, built-in, dan finishing yang boleh capai RM 60,000 hingga RM 120,000. Rumah lama mungkin perlukan rewiring dan plumbing baru (RM 15,000 hingga RM 40,000) tetapi sudah ada built-in dan finishing yang berfungsi. Jumlah keseluruhan boleh sama."
  - q: "Apa kategori kerja yang khas untuk rumah lama tetapi tiada untuk rumah baru?"
    a: "Tiga kategori utama: (1) electrical rewiring jika unit lebih 15 tahun, (2) plumbing replacement jika ada tanda-tanda paip lama, dan (3) waterproofing semula untuk bilik air dan balcony. Kerja ini tidak diperlukan untuk new launch tetapi wajib diperiksa untuk unit lebih 10 tahun."
  - q: "Patutkah saya buat inspeksi kontraktor sebelum beli unit lama?"
    a: "Ya, dan ini adalah RM 800 hingga RM 1,500 yang paling worth-it dalam pembelian sub-sale. Inspeksi profesional boleh kesan rewiring lama, paip aluminium berkarat, kelembapan dalam dinding, atau tanda-tanda anai-anai — semua perkara yang boleh tambah RM 30,000 hingga RM 80,000 kepada kos renovasi anda."
---
...
1. **Spec creep** — anda dapat akses ke 3D rendering yang cantik dan terus mahu upgrade kepada bahan lebih premium. Bajet RM 60,000 jadi RM 95,000.
2. **Renovate sebelum tahu** — kerana unit baru, anda renovate ikut andaian gaya hidup, bukan pengalaman sebenar.
3. **Defect liability conflict** — sebarang kerja anda boleh menjejaskan tuntutan defect dengan developer.

### Risiko untuk pembeli rumah lama

1. **Surprise discovery** — kontraktor mula buka dinding, jumpa wiring lama yang dah patut tukar. Kos tambah RM 8,000 yang tidak dianggar.
2. **Mismatch antara baru dan lama** — anda upgrade dapur cantik, tetapi bilik air masih lama dan kelihatan tidak konsisten. Akhirnya renovate semua = bajet membesar.
3. **Foundation issue** — sangat jarang tetapi serius. Tanah turun atau dinding retak struktur boleh jadi RM 50,000+ untuk baikpulih.
