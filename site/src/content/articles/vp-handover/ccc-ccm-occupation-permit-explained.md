...
tags: ["ccc", "ccm", "vp", "compliance"]
includeFitoutNote: false
faqs:
  - q: "Is CCC the same as CFO/OC?"
    a: "CCC replaced the older CFO (Certificate of Fitness for Occupation) in Malaysia in 2007 under the new self-certification regime. Effectively yes, but the issuing party shifted from local authority to the Principal Submitting Person (the project's architect or engineer). The legal effect is the same: the building is certified safe and lawful to occupy."
  - q: "Can I move in without CCC?"
    a: "No. Occupying a property without CCC is technically an offence under the Street, Drainage and Building Act 1974, and your developer cannot legally hand over Vacant Possession without it. If a developer pressures you to take VP 'pending CCC', that is a major red flag — the building has either failed inspection or is incomplete in a way the PSP won't sign off on."
  - q: "What does CCC NOT prove?"
    a: "CCC certifies safety, structural integrity, and compliance with approved plans. It does NOT certify finishing quality, workmanship, individual unit defects, or that what was built matches what you were sold in the marketing brochure. Those are separate inspections — VP joint inspection, defect list, DLP claims."
---
...
1. **Strata buildings, post-VP**, when the JMB is conducting its handover inspection of common areas (lifts, gensets, fire systems, pools). Defects flagged here become the developer's obligation to fix during the management handover period — separate from your unit's DLP.
2. **Sub-sale buyers** of older condos, where you want to verify the JMB received a clean CCM and that any unresolved items from the original handover are documented.
