...
coverAlt: "Ilustrasi — review dokumen SPA dan kontrak"
coverCredit: "Unsplash"
locale: en
category: legal
pillar: true
publishedAt: 2026-06-25
tags: ["spa", "schedule-g", "schedule-h", "lad", "first-home"]
includeFitoutNote: false
faqs:
  - q: "Can I negotiate SPA terms with a developer?"
    a: "For Schedule G/H standard SPAs (residential under HDA), the core clauses are statutorily fixed — developer cannot lawfully reduce your protections (DLP, LAD, retention sum, etc.). What IS negotiable: side letters on freebies, completion timeline carve-outs, holding charge waivers, payment schedule adjustments. Push back on these, not the statutory clauses."
  - q: "What's the difference between SPA and S&P?"
    a: "Same thing. SPA (Sale and Purchase Agreement) and S&P (Sale & Purchase) are interchangeable terms. The Malaysian legal community uses SPA more often in commercial property; new-launch residential developers use either."
  - q: "Should I bring my own lawyer or use developer's panel lawyer?"
    a: "Strong recommendation: bring your own. Developer's panel lawyer's primary client is the developer. Even if technically representing both sides for SPA, conflict of interest is structural. Engage independent conveyancer for at minimum the SPA review and stamp duty filing. For loan documentation, you can use bank's panel lawyer (less conflict)."
---
...
Refer to our [DLP strata vs landed file](/vp-handover/dlp-extension-strata-vs-landed/) for how to actually use the 24 months.
