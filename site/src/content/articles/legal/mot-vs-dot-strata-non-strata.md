...
tags: ["mot", "doa", "strata-title", "individual-title"]
includeFitoutNote: false
faqs:
  - q: "If my condo only has master title, am I a real owner?"
    a: "Legally yes — your beneficial ownership is documented via Deed of Assignment (DOA) executed between developer and you. You can sell, refinance, will, and use the unit. But you don't have direct legal title until strata title is issued and MOT is registered in your name. This dual structure (master title held by developer/proprietor, beneficial via DOA) is normal in Malaysia for strata properties pre-strata-title."
  - q: "Why does strata title take so long to issue?"
    a: "Three reasons typically: (1) developer hasn't completed all common-area works needed for the JMB to be formed; (2) state land office backlog (some states have multi-year backlogs for strata title applications); (3) outstanding payments or land matters between developer and state. Worst case, strata titles issued 8-12 years after VP. The push-back tool: collective JMB action against developer."
  - q: "Can I refinance without strata title?"
    a: "Yes — banks routinely refinance against DOA. Slight valuation discount may apply (banks see DOA as marginally riskier than registered title), and not all banks accept DOA properties (some only do registered title). Once strata title is issued and MOT registered, refinancing options expand."
---
...
- MOT: stamp duty on the transfer instrument, calculated on purchase price tier (covered in our [stamp duty file](/loan/mot-stamp-duty-calculator-2026/))
...
1. Demand at every AGM: status update on strata title application, with documentary evidence (developer's letter to state land office, state land office acknowledgement)
2. Engage JMB panel lawyer if delays exceed 3 years post-VP without legitimate state-side explanation
3. File complaint with COB (Commissioner of Buildings) — local authority body that supervises strata management
4. If sustained delay (5+ years), file court action for declaration that developer is in breach of obligation to deliver title
