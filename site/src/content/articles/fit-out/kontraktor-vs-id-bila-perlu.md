...
tags: ["kontraktor", "interior-designer", "renovation"]
includeFitoutNote: true
faqs:
  - q: "Apa beza fee Interior Designer dengan kontraktor?"
    a: "Interior Designer (ID) caj design fee terpisah — biasanya RM 3-RM 8 per sqft untuk concept design, atau 8-15% dari construction cost untuk full project management. Kontraktor caj on construction cost sahaja, tanpa design fee separate. Kalau scope anda hanya cabinet swap atau cat semula, ID adalah pemborosan. Kalau anda buat full strip renovation termasuk layout change, ID berbaloi untuk avoid mistake yang lebih mahal."
  - q: "Boleh saya engage ID untuk design sahaja, kemudian appoint kontraktor sendiri?"
    a: "Ya, dipanggil 'design only' engagement. ID hantar drawings dan spec, anda tender kontraktor sendiri. Selalunya ID akan kurangkan fee kepada hanya 3-5 RM/sqft tetapi tarik diri dari quality control. Risk: drawings yang ID buat mungkin assume material yang ID's preferred contractor biasa guna; kontraktor lain mungkin price untuk material berbeza dan finished result tak match expectation."
  - q: "Berapa kos full renovation untuk kondo 1,000 sqft di Klang Valley?"
    a: "Range 2026 untuk Klang Valley: cosmetic refresh (cat, lighting, minor cabinet) RM 25k-RM 50k; mid-tier renovation (kitchen redo + wet area + cabinetry) RM 80k-RM 150k; full strip dengan layout change RM 150k-RM 280k. Add 25-40% kalau guna ID full project. Numbers depend banyak pada material spec dan kompleksiti."
---
...
1. **Three quotes dengan itemised breakdown.** Quote yang single lump sum ("renovation = RM 65k") tidak boleh dipertahankan. Demand line item untuk material, labour, finishing per area.
2. **Reference recent project.** Bukan portfolio website (boleh mengandungi kerja yang bukan diorang punya). Tanya 2-3 client nama yang anda boleh hubungi sendiri.
3. **Site visit kepada kerja yang sedang berjalan.** Kalau kontraktor enggan bawa anda lihat, itu signal merah.
4. **Insurance dan registration.** CIDB registered (verify online), ada workman compensation insurance, dan ada PI insurance untuk damage.
5. **Payment schedule yang reasonable.** 30% deposit, 30% mid-progress, 30% pre-handover, 10% retention 30-60 hari post-handover. Hati-hati dengan kontraktor yang minta 50%+ upfront.
...
1. **Hire ID untuk scope yang sebenarnya tak perlu ID.** Bayar RM 15k design fee untuk renovation RM 50k yang seorang kontraktor competent boleh handle. Net waste: RM 12k.
2. **Hire kontraktor murah untuk scope yang complex.** Jimat RM 8k pada quote, tetapi end up dengan defect yang cost RM 20k-RM 40k untuk remediate. Worst case: kena tear out dan redo.
3. **Skip planning phase entirely.** Mula renovation dengan "saya akan figure out as we go". Hasil: kos balloon 40-60% dari original estimate, dan finished result tidak coherent.
