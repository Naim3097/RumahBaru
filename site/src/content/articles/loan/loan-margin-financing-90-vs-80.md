...
tags: ["margin-financing", "mrta", "loan", "first-home"]
includeFitoutNote: false
faqs:
  - q: "Adakah semua bank offer 90% margin untuk first-time buyer?"
    a: "Bank-bank tempatan utama (Maybank, CIMB, RHB, Public Bank) memang offer sehingga 90% MoF untuk first-time buyer property kediaman. Tetapi ada syarat — DSR mesti dalam range yang dibenarkan, property mestilah completed atau under construction dengan developer reputable, dan sometimes hanya pada produk loan tertentu (bukan semua promosi). Periksa dengan banker, jangan andai semua promosi termasuk 90%."
  - q: "Kalau saya dapat hanya 80%, perlukah saya tukar bank?"
    a: "Bukan automatik. Pertama check sebab bank offer 80%: DSR terlalu tinggi (improvement: kurangkan loan lain), credit score rendah (improvement: 6 bulan pembersihan record), atau valuation property yang rendah (banker akan beritahu). Kalau sebabnya valuation, tukar bank pun mungkin sama jawapan. Kalau sebabnya DSR / credit, ada peluang naik kembali."
  - q: "Apa beza MRTA dan MLTA, mana lebih murah?"
    a: "MRTA (Mortgage Reducing Term Assurance) adalah single-premium, jumlah berkurang sepanjang loan tenor. MLTA (Mortgage Level Term Assurance) adalah monthly premium, jumlah tetap. MRTA lebih murah keseluruhan tetapi tied dengan loan — kalau anda settle awal atau refinance, premium MRTA tidak refundable. MLTA fleksibel tetapi 2x-3x lebih mahal. Untuk kebanyakan first-time buyer, MRTA adalah default, MLTA hanya jika anda yakin akan refinance dalam 5-10 tahun."
---
