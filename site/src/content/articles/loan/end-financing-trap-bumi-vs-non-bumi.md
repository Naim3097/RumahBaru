...
tags: ["end-financing", "bumi-lot", "disbursement", "loan"]
includeFitoutNote: false
faqs:
  - q: "Can a non-bumi buyer purchase a bumi-allocated unit?"
    a: "Yes, with state consent. Each state has its own rules. In Selangor, non-bumi buyers can apply to release a bumi-allocated unit if (a) the unit has been on the bumi reserve for 12+ months without a bumi buyer and (b) a release levy is paid (currently 3–7% of purchase price, varies). The application process takes 4–9 months on average."
  - q: "What's the practical risk if state consent is delayed?"
    a: "Your loan disbursement is held back. Your developer cannot register the MOT in your name without state consent. Your bank cannot release the loan to developer without registered MOT. Meanwhile, you may be paying interest-only on the loan amount you've drawn down (if it's progressive disbursement) or holding charges to the developer. Worst case: 6–9 months of accumulated cost with no occupancy."
  - q: "Should I avoid bumi-allocated units entirely?"
    a: "No, but go in with eyes open. Bumi-allocated units typically come with a 7-15% discount built in (the bumi rebate). For non-bumi buyers, the release levy and the financing delay erode some or all of that discount. Mathematically it can still be worth it — but only if your conveyancer has confirmed in writing what the state release process looks like for your specific district."
---
...
1. SPA signed and stamped
2. MOT registered in buyer's name at land office
3. Bank's charge perfected (registered against title)
4. Then — and only then — bank disburses to developer
...
1. **District-specific consent timeline.** "Selangor" is too broad; consent for a Subang Jaya unit may be processed differently from one in Sepang. Ask your conveyancer for the typical timeline for **your specific district** in the past 12 months.
2. **Release levy quantum.** State levies are gazetted but vary year-to-year. For a RM 600,000 unit, release levy in Selangor is typically RM 18,000–RM 42,000. Confirm the figure in writing before SPA.
3. **Existing application status.** Ask the developer for evidence that the unit has actually been on bumi reserve for the required period and was unsold to a bumi buyer. Some developers re-shuffle bumi allocation late in the project — meaning your "released" unit may not have actually been on reserve, and consent may be denied.
